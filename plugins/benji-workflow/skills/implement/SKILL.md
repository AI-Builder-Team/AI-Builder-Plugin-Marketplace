...
- **Small specs (1-3 FRs):** Single commit for all tests
- **Medium/Large specs (4+ FRs):** Per-FR or grouped commits
...
Commit granularity matches spec size (see Commit Granularity in features.md):
- **Small specs (1-3 FRs):** Single commit for all implementation
- **Medium/Large specs (4+ FRs):** Per-FR or grouped commits
