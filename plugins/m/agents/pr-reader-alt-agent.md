...
- The `/pr-reader` skill handles EVERYTHING — fetching, formatting, writing to file.
...
2. Invoke the Skill tool: `skill: "pr-reader"`, `args: "<constructed args>"`.
